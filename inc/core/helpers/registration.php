...
namespace Revolt_Framework\Core\Helpers\Registration;
 ...
 */
function validate_and_register_new_user($username, $email, $password)
{
    $errors = new WP_Error();
...
function get_template_html($template_name, $attributes = null)
{
    ...
    require(REVOLT_FRAMEWORK_DIR . 'inc/frontend/html-templates/' . $template_name . '.php');
