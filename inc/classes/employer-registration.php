...
class Employer_Registration{
    ...
    public function render_registration_form( $user_attributes, $content = null ) {
        ...
        $default_attributes = array( 
            'show_title'    => false,
            'title'         => '',
            'button_text'   => __( 'Register', 'lofi-framework' ),
            'disabled'      => false,
            );
        ...
        if ( current_user_can('manage_options') ) {
            ...
            if ( $in_elementor_editor || $in_elementor_preview ){
                ...
                return $this->get_template_html( 'registration_form_employer', $attributes );
            }
    ...
    public function handle_form_response(){
        ...
        if( ! wp_verify_nonce( $_POST['lofi-registration-nonce']  , 'lofi_registration_form_action'  ) ) {
            return;
        }
    ...
    public function do_register_employer($username, $email, $password) {
            ...
            //} elseif ( ! $this->verify_recaptcha() ) {
                ...
                $result = $this->validate_and_register_employer( $username, $email, $password );
     ...
     */
    private function validate_and_register_employer( $username, $email, $password ) {
        $errors = new WP_Error();
    ...
    */
    public function init(){
        ...
        //Registration
        add_shortcode( 'lofi-employer-registration-form', array( $this, 'render_registration_form' ) );
        
        // Add captcha javascript to footer
        add_action( 'wp_print_footer_scripts', array( $this, 'add_captcha_js_to_footer' ) );

        // Handle form response
        add_action( 'admin_post_nopriv_lofi_registration_form_action', array($this, 'handle_form_response' ));
    }
